...
contract Register
{
    ...
    function register(string name,uint _loan_interst,uint _fixed_deposit,uint _acc_dep_int)public returns(string)
    {
    ...
    function show_registers() public view returns(uint)
    {
        return reg_user.length;
    }
